...
namespace ProjetCegep.Controleurs
{
    ...
    public class CegepControleur
    {
        ...
        /// <summary>
        /// Méthode de service permettant de vider la liste des départements.
        /// </summary>
        ...
        /// </summary>
        /// <param name="nomCegep">Le nom du Cégep.</param>
        /// <param name="departement">Le DTO du département à modifier.</param>
        public void ModifierDepartement(string nomCegep, DepartementDTO departement)
        {
            ...
            Departement departementModel = new Departement(departementDTO.No, departementDTO.Nom, departementDTO.Description);

            if (departement.No != departementModel.No || departement.Description != departementModel.Description)
            {
        ...
        /// <summary>
        /// Méthode de service permettant de vider la liste des enseignants.
        /// </summary>
        /// <param name="nomCegep">Le nom du Cégep.</param>
        ...
        public void ViderListeEnseignant(string nomCegep, string nomDepartement)
        {
            ...
            {
                throw new Exception("Erreur lors de la suppression de tous les enseignants.", ex);
            }
        }
...
/// Namespace pour les classes de type Controleur.
/// </summary>
namespace AndroidCegep2024.Controleurs
{
    /// <summary>
    /// Classe représentant le controleur de l'application.
    /// </summary>
